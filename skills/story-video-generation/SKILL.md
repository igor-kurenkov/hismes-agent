...
```bash
# 为每个场景生成图片（16:9 比例）
generate-image.js "[场景的 AI prompt]" ~/images/scene_001.png 1728x960

generate-image.js "[场景的 AI prompt]" ~/images/scene_002.png 1728x960
...
```
...
```bash
# 为每个场景生成配音（WAV格式）
generate-tts.js "字幕1" ~/images/narration_001.wav tongtong 1.0
generate-tts.js "字幕2" ~/images/narration_002.wav tongtong 1.0
...
```
...
```bash
# 将每个场景的字幕和配音文件作为参数传入
python3 ~/generate_video.py ~/images \
